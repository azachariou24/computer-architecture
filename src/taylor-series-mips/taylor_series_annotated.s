...
#   main
#     |
#     +--> Initialize number of terms (n = 100)
#     |
#     +--> Initialize floating-point loop variable
#     |
#     +--> Execute main loop over input values
#     |
#     +--> Terminate program
#############################################################################
...
#     |
#     +--> Call Taylor_ln() iterative implementation
#     |
#     +--> Print iterative result
#     |
#     +--> Call Taylor_lnRecursive() recursive implementation
#     |
#     +--> Print recursive result
#     |
#     +--> Increment input value and repeat
#############################################################################
...
#
# Purpose:
#   Recursive helper for the Taylor series approximation.
#
# Parameters:
#   $f13 : transformed input value
#   $a1  : current term index i
#   $a2  : maximum number of terms n
#
# Returns:
#   $f1  : partial recursive Taylor series sum
#
# Flow:
#   Taylor_lnR(x, i, n)
#     |
#     +--> if i > n return 0.0
#     |
#     +--> compute current Taylor term
#     |
#     +--> return current term + Taylor_lnR(x, i + 1, n)
#############################################################################
...
#############################################################################
# Function: Taylor_lnRecursive
#
# Purpose:
#   Prepares arguments and starts the recursive Taylor series computation.
#
# Parameters:
#   $f14 : input value x
#   $a3  : number of terms n
#
# Returns:
#   $f2  : recursive approximation of ln(1 + x)
#
# Flow:
#   Taylor_lnRecursive
#     |
...
#
# Purpose:
#   Computes the Taylor series approximation iteratively.
#
# Parameters:
#   $f14 : input value x
#   $a3  : number of terms n
#
# Returns:
#   $f2  : iterative approximation of ln(1 + x)
#
# Flow:
#   Taylor_ln
#     |
